...
def path_length(jsonfile, coords):
    ...
    dwg.add(path)
    dwg.add(dwg.text("99", insert=(50, 0), stroke='none', fill='#ffff7f', font_size='50px', font_weight="bold", font_family="Arial"))
    dwg.add(dwg.text("88", insert=(50, 100), stroke='none', fill='#ffff7f', font_size='50px', font_weight="bold", font_family="Arial"))
