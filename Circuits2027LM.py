...
for i in range(count):
    ...
    my_canvas.drawString(circuit_x + left_margin + int(circuitsdata[i][10]) + 10, circuit_y + bottom_margin + int(circuitsdata[i][11]) + 17, f"{length}")
    my_canvas.setFont(cirfont, 7)
    my_canvas.drawString(circuit_x + left_margin + int(circuitsdata[i][10]) + 10, circuit_y + bottom_margin + int(circuitsdata[i][11]) + 8, f"{altitude}")
