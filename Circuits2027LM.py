...
for i in range(count):
    ...
    if circuitsdata[i][9] == "a":
        renderPDF.draw(scalecolorSVG("SVG/turnleft.svg", clockwisescale, "#0000ff"), my_canvas, circuit_x +  (colwidth - namewidth) / 2 + namewidth + 2, circuit_y)
    else:
        renderPDF.draw(scalecolorSVG("SVG/turnright.svg", clockwisescale, "#0000ff"), my_canvas, circuit_x + (colwidth - namewidth) / 2 + namewidth + 2, circuit_y)
