...
for i in range(count):
    ...
    renderPDF.draw(scaleSVG("SVG/rightarrow.svg", arrowscale), my_canvas, circuit_x + left_margin + int(circuitsdata[i][10]) + 23, circuit_y + bottom_margin + int(circuitsdata[i][11]) + 20)
