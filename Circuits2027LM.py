...
for i in range(count):
    ...
    if circuitsdata[i][9] == "a":
        renderPDF.draw(scaleSVG("SVG/arrow-shape-turn-left.svg", clockwisescale), my_canvas, circuit_x + left_margin + namewidth + 10, circuit_y + bottom_margin - 9)
    else:
        renderPDF.draw(scaleSVG("SVG/arrow-shape-turn-right.svg", clockwisescale), my_canvas, circuit_x + left_margin + namewidth + 10, circuit_y + bottom_margin - 9)
