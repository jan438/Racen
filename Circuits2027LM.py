...
for i in range(count):
    ...
    my_canvas.drawString(circuit_x + left_margin + int(circuitsdata[i][10]) + info_dx, circuit_y + bottom_margin + int(circuitsdata[i][11]) + 12, f"{altitude}" + "m")
    renderPDF.draw(scaleSVG("SVG/altitude2.svg", arrowscale), my_canvas, circuit_x + left_margin + int(circuitsdata[i][10]) + 30, circuit_y + bottom_margin + int(circuitsdata[i][11]) + 12)
