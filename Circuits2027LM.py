...
for i in range(count):
    ...
    renderPDF.draw(scaleSVG("SVG/ruler.svg", arrowscale), my_canvas, circuit_x + left_margin + int(circuitsdata[i][10]) + 25, circuit_y + bottom_margin + int(circuitsdata[i][11]) + 18)
