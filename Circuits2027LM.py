...
for i in range(count):
    ...
    if circuitsdata[i][9] == "a":
        renderPDF.draw(scaleSVG("SVG/turnleft.svg", clockwisescale), my_canvas, circuit_x +  (colwidth - namewidth) / 2 + namewidth + 2, circuit_y)
    else:
        renderPDF.draw(scaleSVG("SVG/turnright.svg", clockwisescale), my_canvas, circuit_x + (colwidth - namewidth) / 2 + namewidth + 2, circuit_y)
