...
for i in range(len(raceevents)):
    ...
    if event == "Race":
        ...
        #   Saudi Monaco    Portugal   GreatBrit  Austria     Belgium   Hungary     Italy      Spain      Singapore  Mexico   Brazil
        if i == 2 or i == 8 or i == 9 or i == 10 or i == 11 or i == 12 or i == 13 or i == 14 or i == 15 or i == 18 or i == 20 or i == 21:
            print(state)
        else:
            state = "Belgium"
            print("else", state)
