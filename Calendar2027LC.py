...
for i in range(len(raceevents)):
    ...
    if event == "Race":
        ...
        if i == 1 or i == 2 or i == 3 or i == 4 or i == 5 or i == 6 or i == 8 or i == 9 or i == 10 or i == 11 or i == 12 or i == 13 or i == 14 or i == 15 or i == 17 or i == 18 or i == 19 or i == 20 or i == 21 or i == 23:
            print(state)
        else:
            state = "Belgium"
            print("else", state)
