...
for i in range(count):
    ...
    #
    # birthday1
    d.add(transform_svg("SVG/calendar-blank.svg", col * colwidth + birthdayx, row * rowheight + 150, 0.5 , 0.5))
    d.add(String(col * colwidth + birthdayx, row * rowheight + 155,"15-02", fontSize = 8, fillColor = colors.black))
    d.add(String(col * colwidth + birthdayx, row * rowheight + 150,"1974", fontSize = 8, fillColor = colors.black))
    #land1 5
    ...
    #birthday2
    d.add(transform_svg("SVG/calendar-blank.svg", col * colwidth + halfcolwidth + birthdayx, row * rowheight + 150, 0.5 , 0.5))
    d.add(String(col * colwidth + halfcolwidth + birthdayx, row * rowheight + 155,"15-02", fontSize = 8, fillColor = colors.black))
    d.add(String(col * colwidth + halfcolwidth + birthdayx, row * rowheight + 150,"1984", fontSize = 8, fillColor = colors.black))
    #land2 9
