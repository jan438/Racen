...
for i in range(count):
    ...
    # logo
    print(formule1data[i][1] + ".svg", "Logowidth", float(formule1data[i][10]), "Logoheight", float(formule1data[i][11]), "Scalingx", float(formule1data[i][12]), "Scalingy", float(formule1data[i][13]))
