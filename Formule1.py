...
for i in range(count):
    ...
    d.add(String(100 + col * colwidth, row * rowheight + 95, "88", fontSize = 18, fillColor = colors.black))
    ...
    d.add(String(90 + col * colwidth + 0.5 * colwidth, row * rowheight + 95, "88", fontSize = 18, fillColor = colors.black))
