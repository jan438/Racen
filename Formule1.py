...
for i in range(count):
    ...
    d.add(Line(col * colwidth + halfcolwidth - 4, row * rowheight + 90, col * colwidth + halfcolwidth - 4, row * rowheight + 92, strokeColor=colors.black, strokeWidth = 1))
    ...
    d.add(Line(col * colwidth + colwidth - 4, row * rowheight + 90, col * colwidth + colwidth - 4, row * rowheight + 92, strokeColor=colors.black, strokeWidth = 1))
    col = col + 1
    if col == 2:
        col = 0
        row = row + 1
