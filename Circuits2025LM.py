...
def GeoJSON_to_Canvas(circuitindex):
    ...
    if circuitindex == 10:
        print("Todo", circuitsdata[circuitindex][0], round(startfinish_offset_x), round(startfinish_offset_y), circuitsdata[circuitindex][0], round(startfinish_offset_x), round(startfinish_offset_y), circuitsdata[circuitindex][0], round(startfinish_offset_x), round(startfinish_offset_y),)
