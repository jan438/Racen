...
for i in range(len(raceevents)):
    ...
    if raceevent is not None:
        if raceevent.categories == "Vrije Training 1,F1":
            ...
            my_canvas.line(col * colwidth + 12.0, row * rowheight + 32.0, col * colwidth + colwidth - 10.0, row * rowheight + 32.0)
            ...
            my_canvas.line(col * colwidth + 140.0, row * rowheight + 30, col * colwidth + 140.0, row * rowheight - 70.0)
