...
def Altitude_to_SVG(jsonfile):
    ...
    with open("Data/" + jsonfile + "-2.json", 'r') as file:
        ...
        dwg.add(path)
        dwg.add(dwg.text('ABC', insert=(55, 60), stroke='none', fill='#ffff7f', font_size='30px', font_weight="bold", font_family="Arial"))
        dwg.save()
    return
if sys.platform[0] == 'l':
