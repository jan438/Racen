...
for i in range(count):
    ...
    svgwidth = svg_root.attrib.get('width')
    svgheight = svg_root.attrib.get('height')
    d.add(transform_svg("Teams/Verstappen.svg", leftmargin + avatarx + col * colwidth, bottommargin + avatary + row * rowheight, 0.065, 0.065))
    #birthday2
    ...
    svgwidth = svg_root.attrib.get('width')
    svgheight = svg_root.attrib.get('height')
    d.add(transform_svg("Teams/Verstappen.svg", leftmargin + avatarx + col * colwidth + 0.5 * colwidth, bottommargin + avatary + row * rowheight, 0.065, 0.065))
