...
for i in range(count):
    ...
    d.add(bottomrightcorner(leftmargin + col * colwidth + 0.5 * colwidth - 8.0 - 4, bottommargin + row * rowheight + 90, 0.5 * avatarwidth, 1, colors.black))
    ...
    d.add(bottomrightcorner(leftmargin + col * colwidth + colwidth - 8.0 -4, bottommargin + row * rowheight + 90, 0.5 * avatarwidth, 1, colors.black))
