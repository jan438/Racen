...
my_canvas.circle(0 * colwidth + 2.1 + float(circuitsdata[0][25]), 5 * rowheight + bottommargin + 10 + float(circuitsdata[0][26]), 4.0, stroke = 0, fill = 1)
...
my_canvas.circle(1 * colwidth + 2.1 + float(circuitsdata[17][25]), 5 * rowheight + bottommargin + 10 + float(circuitsdata[17][26]), 4.0, stroke = 0, fill = 1)
