...
my_canvas.circle(1 * colwidth + 2.1 + 85, 3 * rowheight + bottommargin + 10 + 55, 4.0, stroke = 0, fill = 1)
...
my_canvas.circle(3 * colwidth + 2.1 + 95, 3 * rowheight + bottommargin + 10 + 55, 4.0, stroke = 0, fill = 1)
...
my_canvas.circle(0 * colwidth + 2.1 + 55, 2 * rowheight + bottommargin + 10 + 55, 4.0, stroke = 0, fill = 1)
...
my_canvas.circle(2 * colwidth + 2.1 + 35, 2 * rowheight + bottommargin + 10 + 85, 4.0, stroke = 0, fill = 1)
image = "Circuits/Location/Spain_location_map.png"
...
my_canvas.circle(1 * colwidth + 2.1 + 85, 0 * rowheight + bottommargin + 10 + 15, 4.0, stroke = 0, fill = 1)
...
my_canvas.circle(2 * colwidth + 2.1 + 85, 0 * rowheight + bottommargin + 10 + 85, 4.0, stroke = 0, fill = 1)
...
my_canvas.circle(3 * colwidth + 2.1 + 85, 0 * rowheight + bottommargin + 10 + 85, 4.0, stroke = 0, fill = 1)
