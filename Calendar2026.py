...
my_canvas.circle(1 * colwidth + 2.1 + 110, 0 * rowheight + bottommargin + 10 + 15, 4.0, stroke = 0, fill = 1)
...
my_canvas.circle(2 * colwidth + 2.1 + 80, 0 * rowheight + bottommargin + 10 + 65, 4.0, stroke = 0, fill = 1)
