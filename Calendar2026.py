...
my_canvas.circle(2 * colwidth + 2.1 + 85, 1 * rowheight + bottommargin + 10 + 42, 4.0, stroke = 0, fill = 1)
...
my_canvas.circle(0 * colwidth + 2.1 + 92, 0 * rowheight + bottommargin + 10 + 33, 4.0, stroke = 0, fill = 1)
