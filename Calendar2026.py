...
my_canvas.circle(0 * colwidth + 2.1 + 35.0, 4 * rowheight + bottommargin + 10 + 48.0, 4.0, stroke = 0, fill = 1)
...
my_canvas.circle(1 * colwidth + 2.1 + 35.0, 4 * rowheight + bottommargin + 10 + 48.0, 4.0, stroke = 0, fill = 1)
...
my_canvas.circle(2 * colwidth + 2.1 + 35.0, 4 * rowheight + bottommargin + 10 + 48.0, 4.0, stroke = 0, fill = 1)
...
my_canvas.circle(3 * colwidth + 2.1 + 35.0, 4 * rowheight + bottommargin + 10 + 48.0, 4.0, stroke = 0, fill = 1)
