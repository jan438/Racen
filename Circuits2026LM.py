...
worldmap_x = 125
worldmap_y = 315
circuitcolors = ["#8250C4", "#ECC846", "#FF0000", "#00FF00", "#FF0000", "#FF0000", "#FF0000", "#00FF00", "#FF0000", "#FF0000", "#FF0000", "#00FF00", "#FF0000", "#FF0000", "#FF0000", "#00FF00", "#FF0000", "#FF0000", "#FF0000", "#00FF00", "#FF0000", "#FF0000", "#FF0000", "#00FF00"]
...
for i in range(count):
    ...
    my_canvas.circle(circuit_x + left_margin + int(circuitsdata[i][10]) + 25, circuit_y + bottom_margin + int(circuitsdata[i][11]) + 15, 1.5, stroke = 0, fill = 1)
    col += 1
    if col == colcount:
        row = row - 1
        col = 0
