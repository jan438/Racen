    ...
    with open("SVG/" + circuit + "LM.svg", 'w') as f:
        ...
        for feature in geojson_data['features']:
            ...
            if geometry['type'] == 'LineString':
                ...
                if cx == 0 and circuit == "AlbertPark":
                    print("Australia")
                    ...
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec3color}"/>\n')
                elif cx == 2 and circuit == "BakuCity":
                    print("Azerbaijen")
                    path = coordinates_to_path([coords[idx3:]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                    path = coordinates_to_path([coords[:idx2 + 1]], scale, translate)
                    ...
                    path = coordinates_to_path([coords[idx3:]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                elif cx == 7 and circuit == "JeddahCorniche":
                    print("Saudi Arabia")
                    path = coordinates_to_path([coords[:idx2 + 1]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                    path = coordinates_to_path([coords[idx2:idx1]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec2color}"/>\n')
                    path = coordinates_to_path([coords[idx1 - 1:idx3]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec3color}"/>\n')
                    path = coordinates_to_path([coords[idx3 - 1:]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec3color}"/>\n')
                elif cx == 8 and circuit == "JoseCarlosPace":
                    print("Brazil")
                    ...
                    path = coordinates_to_path([coords[idx3 - 1:]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec3color}"/>\n')
                elif cx == 9 and circuit == "LasVegas":
                    print("USA_Nevada")
                    path = coordinates_to_path([coords[:idx2 + 1]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                    path = coordinates_to_path([coords[idx2 - 1:idx3 + 1]], scale, translate)
                    ...
                    path = coordinates_to_path([coords[idx2:idx3 + 1]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec3color}"/>\n')
                elif cx == 11 and circuit == "Madring":
                    print("Spain")
                    path = coordinates_to_path([coords[:idx2 + 1]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                    ...
                    path = coordinates_to_path([coords[idx3 - 1:]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec3color}"/>\n')
                elif cx == 12 and circuit == "MarinaBay":
                    print("Singapore")
                    path = coordinates_to_path([coords[idx2:]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                    ...
                    path = coordinates_to_path([coords[idx1 - 1:]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                elif cx == 16 and circuit == "Portimão":
                    print("Portugal")
                    path = coordinates_to_path([coords[:idx3 + 1]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                    ...
                    path = coordinates_to_path([coords[idx2:]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                elif cx == 17 and circuit == "RedBullRing":
                    print("Austria")
                    path = coordinates_to_path([coords[:idx2 + 1]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                    path = coordinates_to_path([coords[idx2 - 1:idx3 + 1]], scale, translate)
                    ...
                    path = coordinates_to_path([coords[:idx3]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                    path = coordinates_to_path([coords[idx3 - 1:idx2]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec2color}"/>\n')
                    ...
                    path = coordinates_to_path([coords[idx3:]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                elif cx == 23 and circuit == "YasMarina":
                    print("Abu Dhabi")
                    path = coordinates_to_path([coords[:idx2 + 1]], scale, translate)
                    f.write(f'<path d="{path}" fill="none" stroke-width="7" stroke="{sec1color}"/>\n')
                    path = coordinates_to_path([coords[idx2 - 1:idx3 + 1]], scale, translate)
